...
const TCGCard = () => {
	...
	return (
		...
		className="group relative [flex -ml-[62px] first:ml-0 min-w-44 min-h-64 w-44 h-64 bg-gradient-to-br from-pink-400 to-violet-600 rounded-lg p-1 drop-shadow-[0_5px_5px_rgba(0,0,0,0.35)] transition ease-in-out duration-200 hover:-translate-y-2 peer peer-hover:relative peer-hover:transition peer-hover:ease-in-out peer-hover:duration-200 peer-hover:translate-x-[72px]">
			...
			<div className={cardVariant == "polychrome" ? "absolute pointer-events-none h-full w-full top-0 left-0 rounded-lg bg-[url('https://res.cloudinary.com/simey/image/upload/Dev/PokemonCards/illusion.webp'),repeating-radial-gradient(75%_75%_at_var(--poly-x)_var(--poly-y),#FF0707FF,#FF00BDFF,#0024FFFF,#00FFF6FF,#B7FA70FF,#FFFE00FF,#FFA100FF,#FF0000FF_170px)] bg-[length:75%,150%_100%] bg-blend-overlay brightness-[0.4] contrast-[1.7] saturate-[1.2] mix-blend-color-dodge" : "hidden"}/>
