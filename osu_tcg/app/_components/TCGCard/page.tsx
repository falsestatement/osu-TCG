...
const TCGCard = () => {
	...
	return (
		...
		onMouseMove={(e) => {
			...
			e.currentTarget.style.setProperty("--poly-x", `${-(normX+2)*150}%`);
			e.currentTarget.style.setProperty("--poly-y", `${-(normY+1)*100}%`);
