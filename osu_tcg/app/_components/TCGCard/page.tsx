...
const TCGCard = ({
	...
	return (
		...
		onMouseMove={(e) => {
			...
			e.currentTarget.style.setProperty("--before-glare-shift", `${-normX*60}px`);
			e.currentTarget.style.setProperty("--after-glare-shift", `${normX*120-120}px`);
