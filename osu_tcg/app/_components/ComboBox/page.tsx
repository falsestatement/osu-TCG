...
const ComboBox = ({
	...
	const filteredList = query === '' || !filtering
		? listData
		: listData.filter((item) => item.toLowerCase().includes(query.toLowerCase()));
	const valid = listData.map((item) => item.toLowerCase()).includes(query.toLowerCase());
